...
FONT_AWESOME = ["https://use.fontawesomecom/releases/v5.10.2/css/all.css"]
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("PS Móveis")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Visite o Site", href="https://www.psmoveis.com.br/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend('Top Vendedores por Equipe')
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
...
def graph5(month, toggle):
    ...
    title = {"text": f"<span style='font-size:80%;'>{df_5['Consultor'].iloc[0]} - Top Consultant</span><br><span style='font-size:70%'>Em vendas - em relação à média</span><br>"},
    ...
    fig5.update_layout({"margin": {"l":0, "r":0, "t":25, "b":0}})
    fig6.update_layout({"margin": {"l":0, "r":0, "t":25, "b":0}})
    return fig5, fig6
